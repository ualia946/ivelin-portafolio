...
const SkillsList = () => {
  ...
  const skills = {
    "¿Qué tecnologías uso?": [
      "Actualmente trabajo con tecnologías como la nube de Azure, Kubernetes, Docker, Terraform, Power BI, SQL Server y MySQL. Estas herramientas me permiten diseñar, implementar y gestionar infraestructuras escalables y seguras en la nube, así como analizar datos para obtener perspectivas valiosas que apoyen la toma de decisiones empresariales.",
    ],
    "Mi Experiencia": [
      "Tengo experiencia en la planificación y desarrollo de infraestructuras en la nube utilizando Azure, así como en la implementación de prácticas DevOps con herramientas como Kubernetes, Docker y Terraform. Además, cuento con habilidades en análisis de datos y visualización utilizando Power BI, SQL Server y MySQL. He trabajado en proyectos que involucran la creación de soluciones escalables y seguras en la nube, así como en la optimización de procesos mediante la automatización y el análisis de datos.",
    ],
    "Mi formacion": [
      "Mi base académica en la Universidad de Almería ha sido el trampolín para mi carrera en la nube. Decidí cursar una doble mención en Tecnologías y Sistemas de Información para tener una visión 360º: desde la administración de servidores Linux hasta la inteligencia de negocio. Actualmente, compagino mi último año de carrera con la preparación técnica oficial de Microsoft, enfocándome en obtener la certificación Azure Administrator Associate (AZ-104) para validar mis conocimientos prácticos",
    ],
    "¿Cómo trabajo en equipo?": [
      "Aplico flujos de trabajo profesionales usando Git, ramas y Pull Requests para revisar y mejorar el código. Mi enfoque es práctico: facilitar la integración del equipo, asegurar la calidad del repositorio y cumplir estrictamente con los plazos de entrega."
    ]
  };
